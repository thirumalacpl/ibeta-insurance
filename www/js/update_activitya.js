...
$.ajax({
  type: "POST",
url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/chat_insu.php?loginistant_insu="+loginistant_insu+"&verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&status_val_inpro="+status_val_inpro+"&remarkg="+remarkg+"&qualification_id="+qualification_id+"&username="+username+"&typofver="+typofver+"&pertobever="+pertobever+"&pertobeverlast="+pertobeverlast+"&task="+task+"&eeemail="+eeemail+"&user_id="+user_id,
...
$.ajax({
  ...
  //url: 'http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/index_verifd_insu.php?',
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_six="+insu_final_one_zero_six+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_one="+insu_final_one_zero_one+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/delete.php?del_id="+del_id,
...
$.ajax({
  type: "POST",
url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/sdoc.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&res="+res+"&qualification_id="+qualification_id+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/chat.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&status_val_inpro="+status_val_inpro+"&remarkg="+remarkg+"&qualification_id="+qualification_id+"&username="+username+"&typofver="+typofver+"&pertobever="+pertobever+"&pertobeverlast="+pertobeverlast+"&task="+task+"&eeemail="+eeemail+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
...
// $('#myPopupr').hide();
$.ajax({url: 'http://ibeta.fourthforce.in/slim_insurance/slim_four_ripsssjs/count.php?region='+region+"&user_id="+user_id+"&state="+state,
