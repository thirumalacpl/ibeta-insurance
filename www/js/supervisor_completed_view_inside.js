...
//alert(oneemp);
  $('.s22').append('<li><a href="http://ibeta.fourthforce.in/documents/addressid/'+oneemp+'"><img src="http://ibeta.fourthforce.in/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
